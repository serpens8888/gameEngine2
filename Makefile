...
INPUTS = $(SRC)/main.cpp $(SND)/soundDevice.cpp $(SND)/soundBuffer.cpp $(SND)/alHelper.cpp $(SND)/soundSource.cpp $(GFX)/window.cpp $(GFX)/vkInstance.cpp $(GFX)/physicalDevice.cpp  $(GFX)/queue.cpp		    $(GFX)/logicalDevice.cpp
